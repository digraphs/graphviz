...
"for a graphviz graph and an object",
[IsGVGraph, IsObject],
{g, o} -> GV_AddSubgraph(g, ViewString(o)));
...
"for a graphviz graph and an object",
[IsGVGraph, IsObject],
{g, o} -> GV_AddContext(g, ViewString(o)));
...
InstallMethod(GV_RemoveNode, "for a graphviz graph and a string",
[IsGVGraph, IsObject],
{g, o} -> GV_RemoveNode(g, ViewString(o)));
